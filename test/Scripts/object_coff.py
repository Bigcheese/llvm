...
class COFFSection(yaml.YAMLObject):
  ...
  def layout(self, coff, index):
    ...
    self.PointerToRawData = default(self.PointerToRawData, -1)
    self.PointerToRelocations = default(self.PointerToRelocations, -1)
    self.PointerToLineNumbers = default(self.PointerToLineNumbers, 0)
    self.NumberOfRelocations = default(self.NumberOfRelocations, len(self.Relocations))
...
class COFF:
  ...
  def layout(self):
    ...
    self.header.NumberOfSymbols = index
